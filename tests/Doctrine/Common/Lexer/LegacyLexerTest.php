...
/**
 * @psalm-type ValidToken = array{value: string|int, type: string, position: int}
 */
class LegacyLexerTest extends TestCase
{
    ...
    {
        $this->expectDeprecationWithIdentifier('https://github.com/doctrine/lexer/pull/81');
        new ConcreteLexer();
    }
